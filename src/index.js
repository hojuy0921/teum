...
export class TeumDatabase extends DurableObject {
  constructor(ctx, env) {
    ...
    try { this.sql.exec("ALTER TABLE messages ADD COLUMN is_read INTEGER DEFAULT 0"); } catch(e) {}
