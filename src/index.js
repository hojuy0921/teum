...
footer{border-top:1px solid var(--line);padding:30px 0 60px;color:#8c857c;font-size:12px}.modalbg{display:none;position:fixed;inset:0;background:#15151566;z-index:50;padding:18px;align-items:center;justify-content:center}.modal{width:min(650px,100%);max-height:91vh;overflow:auto;background:var(--paper);border-radius:20px;padding:23px}.modal:has(.msgPanel){padding:23px;overflow:hidden}.close{float:right;border:0;background:none;font-size:23px}.field{margin:11px 0}.field label{display:block;font-size:12px;color:#777;margin-bottom:6px;font-weight:750}.field input,.field textarea,.field select{width:100%;background:#fff;border:1px solid #ded7ca;border-radius:10px;padding:11px;outline:0}.field textarea{min-height:110px;resize:vertical}.row{display:grid;grid-template-columns:1fr 1fr;gap:10px}.actions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px}.small{font-size:12px;color:#8a8379;line-height:1.6}.toast{display:none;position:fixed;left:50%;bottom:24px;transform:translateX(-50%);z-index:70;background:#111;color:#fff;padding:12px 16px;border-radius:11px}
