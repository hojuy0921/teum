...
@media(max-width:820px){.navlinks{display:none}.hero{grid-template-columns:1fr;padding-top:47px}.hero h1{font-size:46px}.grid{grid-template-columns:1fr 1fr}.feature{grid-template-columns:1fr}.bottom{display:flex;position:fixed;z-index:35;bottom:0;left:0;right:0;background:#f8ffff;border-top:1px solid var(--line);justify-content:space-around;padding:9px}.bottom button{border:0;background:transparent;font-size:11px;color:#54757a}.bottom b{display:block;font-size:17px;margin-bottom:2px;color:var(--ocean)}}
