...
export class TeumDatabase extends DurableObject {
  ...
  authorized(req){const expected=String(this.env.TEUM_ADMIN_KEY||"");const raw=String(req.headers.get("Authorization")||"").replace(/^Bearer /,"");let got=raw;try{got=decodeURIComponent(raw)}catch(e){}return !!expected&&!!got&&got===expected}
